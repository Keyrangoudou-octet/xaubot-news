...
elif any(kw in title_lower for kw in ["powell speaks", "fed chair", "powell"]):
    return "<b>POWELL SPEAKS - " + event_title + "</b>\n\nSURVEILLE LE MARCHE !\n\nLe robot peut trader mais reste vigilant\nSi le marche bouge fort -> coupe Algo Trading\nMouvement possible : 30-80 pips"

elif any(kw in title_lower for kw in ["trump speaks", "president trump", "trump"]):
    return "<b>TRUMP SPEAKS - " + event_title + "</b>\n\nATTENTION - EVENEMENT IMPREVISIBLE !\n\nSurveille le marche de pres\nSi annonce importante -> coupe Algo Trading immediatement\nMouvement possible : 50-150 pips"
...
```
    ...
    gold_keywords = [
        ...
        "pce", "inflation", "trump speaks",
        "president trump", "fed chair"
    ]
